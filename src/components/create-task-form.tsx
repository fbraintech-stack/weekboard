        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{
                  borderColor: type === "recurrent" ? "rgba(from var(--th-accent) r g b / 0.3)" : "var(--th-border)",
                  background: type === "recurrent" ? "var(--th-accent-muted)" : "var(--th-surface)",
                  color: type === "recurrent" ? "var(--th-accent)" : "var(--th-text-faint)",
                }}
              >
                Recorrente
              </button>
              <button
                ...
                className="flex-1 rounded-[10px] border px-3 py-2.5 text-xs font-medium transition-all"
                style={{
                  borderColor: type === "oneoff" ? "var(--th-badge-pontual-text)" : "var(--th-border)",
                  background: type === "oneoff" ? "var(--th-badge-pontual)" : "var(--th-surface)",
                  color: type === "oneoff" ? "var(--th-badge-pontual-text)" : "var(--th-text-faint)",
                }}
              >
                Pontual
              </button>
              <button
                ...
                className="flex-1 rounded-[10px] border px-3 py-2.5 text-xs font-medium transition-all"
                style={{
                  borderColor: type === "scheduled" ? "var(--th-badge-scheduled-text)" : "var(--th-border)",
                  background: type === "scheduled" ? "var(--th-badge-scheduled)" : "var(--th-surface)",
                  color: type === "scheduled" ? "var(--th-badge-scheduled-text)" : "var(--th-text-faint)",
                }}
              >
                Agendada
              </button>
          ...
          {type === "scheduled" && (
            <div>
              ...
              />
              {scheduledDate && (
                <p className="mt-1.5 text-[11px]" style={{ color: "var(--th-text-muted)" }}>
                  Aparecerá na coluna de {DAY_LABELS[getDayOfWeekFromDate(scheduledDate)]}
                </p>
              )}
            </div>
          )}
              ...
              <div className="flex gap-1.5">
                {allDays.map((day) => (
                  <button
                    ...
                    style={{
                      background: selectedDays.includes(day) ? "var(--th-accent)" : "var(--th-surface)",
                      color: selectedDays.includes(day) ? "#ffffff" : "var(--th-text-muted)",
                    }}
                  >
                    {DAY_LABELS[day]}
                  </button>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                style={{
                  background: categoryId === null ? "var(--th-surface-raised)" : "var(--th-surface)",
                  color: categoryId === null ? "var(--th-text)" : "var(--th-text-muted)",
